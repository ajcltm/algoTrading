...
class FakeTransactionRepository(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.timer = timers.FakeTimer()

        self.cash_id_1 = utils.utils.create_id()
        self.asset_id_1 = utils.utils.create_id()
        self.order_id_1 = utils.utils.create_id()
        ...
        self.cash_id_2 = utils.utils.create_id()
        self.asset_id_2 = utils.utils.create_id()
        self.order_id_2 = utils.utils.create_id()
        ...
        self.cash_id_3 = utils.utils.create_id()
        self.asset_id_3 = utils.utils.create_id()
        self.order_id_3 = utils.utils.create_id()
        ...
        self.cash_id_4 = utils.utils.create_id()
        self.asset_id_4 = utils.utils.create_id()
        self.order_id_4 = utils.utils.create_id()
